...
rg -n $markers VisionStation.Vision/TemplateMatching VisionStation.Infrastructure/FileTemplateModelStore.cs
rg -n $markers docs/development -g 'halcon-shape-*.md'
```
...
Remove-Item Env:\VISIONSTATION_HALCON_DATASET -ErrorAction SilentlyContinue
